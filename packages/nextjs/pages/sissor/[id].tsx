     ...
     <div className="flex items-center flex-col flex-grow pt-7">
      <div className="px-5">
        <h1 className="text-center">
          <span className="block text-2xl mb-2">Are you sure to mate it with the frog at position {id}?</span>
        </h1>

        <span className="block text-md text-slate-500 mb-5">* You will get 2 eggs</span>
