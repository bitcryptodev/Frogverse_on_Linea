...
export const BoardMain = () => {
  ...
  return (
    <div>
      <div className="flex">
        <div>
          <h2 className="mt-4 text-3xl flex items-center"> Frog Pond </h2>
        ...
        <div>
          ...
          <div>
            <h2 className="mt-4 text-3xl">Cute little eggs cotaining tadpoles</h2>
            <div className="flex flex-wrap" style={{ width: "500px"}}>
              ...
              {bagData && !bagData.length && <p>No eggs. Buy some eggs <Link href="/marketplace" passHref className="link">
                here
              </Link></p>}
            </div>
          </div>
